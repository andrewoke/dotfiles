...
if [ -x /usr/local/Cellar/zsh/5.0.6/bin/zsh ] ; then
	zshPath=/usr/local/Cellar/zsh/5.0.6/bin/zsh
...
# minimize into application icon instead of to the right
...
## open all windows from last session
...
open "$HOME/.dotfiles/init/Mathias.terminal"
defaults write com.apple.Terminal "Default Window Settings" -string "Mathias"
defaults write com.apple.Terminal "Startup Window Settings" -string "Mathias"

cp $HOME/.dotfiles/oh-my-zsh/templates/zshrc.zsh-template $HOME/.zshrc
#
